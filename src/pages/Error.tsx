...
function Error() {
  const error: RouteError = useRouteError() as RouteError; // Cast to RouteError type
    ...
    <div className="py-10 bg-base-100">
      ...
      <div className="text-center">
        ...
        <div className="mt-4 flex items-center justify-center gap-x-3">
          ...
          <Link to="/contact" className="rounded-md btn btn-primary btn-sm text-sm font-semibold">
            Contact us
          </Link>
        </div>
      </div>
